...
```{r}
# Detach plyr and Rmisc
#detach("package:Rmisc", unload = TRUE)
#detach("package:plyr", unload = TRUE)

# Now reload dplyr to make sure it's on top
#library(dplyr)
```
...
# Site as factor instead of random (if you want to compare)
...
# Check the structure
str(nucella_one_month_meas)
head(nucella_one_month_meas, 20)
...
# Check structure
str(nucella_one_month_measurement)
View(nucella_one_month_measurement)
...
# Check the summary - should have 4 rows
print(summary_stats_width_one_month)
...
print(summary_stats_ratio_one_month)
...
# Check the structure
str(nucella_4month_meas)
head(nucella_4month_meas, 20)
...
# Check structure
str(nucella_4month_averages)
View(nucella_4month_averages)
...
# Check the summary - should have 4 rows
print(summary_stats_length_4month)
...
# Check the summary - should have 4 rows
print(summary_stats_width_4month)
